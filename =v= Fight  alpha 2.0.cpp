...
int main()
{
	//玩家
		...
		//玩家基本属性:
					...
					int p_hp = 1000, p_strength = 100, p_dodge = 10, p_critical = 20, p_luck = 0, p_VIT = 100, \
						...
						p_attack_range_short = 100, p_attack_range_long = 0, p_speed = 20, p_magic = 100;	
					//  力量基准值						暴击率基准值
	...
	//BOSS
		//BOSS基本属性:
				...
				int b_hp = 10000, b_strength = 60, b_dodge = 20, b_critical = 20, b_attack_range = 100, b_speed = 50;
